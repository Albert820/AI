...
#cap = cv2.VideoCapture(r"/home/cheng/dir_for_label_data/龍佃/0407/gopro/20220407/左/GH011773.MP4")
...
frame_num = 770 # 3915: 16:53:26.42    第一張:16.15.59
#frame_num = 1517 # 3915: 16:53:26.42    第一張:16.15.59

k=0
cv2.namedWindow('frame_left')
cv2.createTrackbar('frame no.','frame_left',0,total_frame-1,set_frame_number)
cv2.setTrackbarPos('frame no.','frame_left',frame_num)  
...
while(True):
    ...
    try:
        ret,frame = cap.read()
        ret,cap2_frame = cap2.read()
        
        cap2_frame2 = cap2_frame[:1080,:]       
        cap2_frame3 = cv2.resize(cap2_frame2,(960,540))
    ...
    if(k%1==0):
        try:
            pass
            cv2.imwrite(r"/home/cheng/dir_for_label_data/gopro/clearer_image/left_cut_pic/%s.png"%k, frame2)
            cv2.imwrite(r"/home/cheng/dir_for_label_data/gopro/clearer_image/right_cut_pic/%s.png"%k, cap2_frame2)
        except:
            pass
    #"""
    frame_num+=1
